document.addEventListener("DOMContentLoaded", function () {
  ...
  toggleBtn.addEventListener("click", function (e) {
    ...
    if (sidebarVisible) {
      ...
      document.querySelector('.app-footer').style.marginLeft = "0";
    } else {
      sidebar.classList.remove("hide");
      document.querySelector('.app-main').style.marginLeft = "250px";
      document.querySelector('.app-footer').style.marginLeft = "250px";
    }
